...
const float DEFAULT_OCTAVE_MAX = 4.0f; // Maximum octave evolution of the image 2^sigma (coarsest scale sigma units)
...
struct KAZEOptions
{
    ...
    int descriptor; // Descriptor grid type 0->SURF, 1->MSURF, 2->GSURF
